    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        with open(self.out_file, 'a') as f:
            for stat in ev.msg.body:
                ...
                # Bỏ flow đã chặn smurf sau 10 dòng
                ...
                # Nếu smurf, tăng counter và sau 10 lần cài rule drop toàn mạng
                if label == 'smurf':
                    self.smurf_count += 1
                    if self.smurf_count == 10:udp
                ...
                # Mitigation individual flow nếu còn cần (drop/rate-limit)
